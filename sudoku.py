...
__author__ = 'Daniel Nobusada & Thales Menato'
""" A Task 5 é a resolução do Sudoku por coloração de Grafos.
"""
...
lista = [9,5,0,0,0,1,0,0,8,0,2,1,8,9,0,6,0,0,3,0,0,0,4,2,1,5,9,2,4,0,0,7,8,0,0,1,1,0,9,3,2,0,0,6,5,8,0,0,1,0,0,0,7,2,4,
         9,0,0,1,0,5,8,0,6,8,2,9,0,0,0,0,4,0,0,0,4,8,3,0,9,6]
t = Tabuleiro(lista)
